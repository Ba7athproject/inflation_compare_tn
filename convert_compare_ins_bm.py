...
def generate_inflation_chart(df: pd.DataFrame, output_file: str = "inflation_compare.png"):
    """
    ...
    colors = {'INS (réel)': '#e63946', 'BM': '#457b9d'}
    markers = {'INS (réel)': 'o', 'BM': '^'}
    ...
    plt.title('Divergeance des taux d\'inflation en Tunisie entre INS & BM (2011-2025)', 
